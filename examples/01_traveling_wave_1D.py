...
from sPOD_tools import shifted_rPCA, shifted_POD_mac, give_interpolation_error, \
    sPOD_Param
...
Nt = Nx//2     # Number of time intervalls
Niter = 3000   # Number of sPOD iterations
Tmax = 0.5     # Yotal time
L = 1          # Yotal domain size
...
if method == "shifted_rPCA":
    ...
    myparams = sPOD_Param(maxit=Niter)
    ret = shifted_POD_mac(qmat, trafos, nmodes, myparams)
